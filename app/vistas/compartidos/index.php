...
$contenido = $control->obtenerCompartidos();
                ...
                <nav class="navbar navbar-expand-lg" style="margin-left: -10px">
                    <ul class="navbar-nav" id="menuOpciones">
                        ...
                        <li class="nav-item ml-3">
                            <button class="btn btn-sm p-2" id="seleccionar" style="border-radius: 10px; background: white; border: 1px solid grey; color: #444">
                                <i class="far fa-check-square pl-4"></i>
